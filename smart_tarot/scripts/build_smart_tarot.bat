@echo off
REM Smart Tarot - Build Script for Windows
REM Builds the Smart Tarot app with tarot-specific configuration

setlocal EnableDelayedExpansion

echo.
echo =========================================
echo   🃏 Building Smart Tarot Application
echo =========================================
echo.

REM Set app-specific environment variables
set "APP_TECHNIQUE=tarot"
set "APP_NAME=Smart Tarot"
set "PRIMARY_COLOR=0xFF4C1D95"
...
if "%1"=="" (
    echo Usage: build_smart_tarot.bat [android^|bundle^|ios^|web^|all]
    echo.
    echo Examples:
    echo   build_smart_tarot.bat android    - Build Android APK only
    echo   build_smart_tarot.bat bundle     - Build Android App Bundle only
    echo   build_smart_tarot.bat ios        - Build iOS IPA only
    echo   build_smart_tarot.bat web        - Build Web application only
    echo   build_smart_tarot.bat all        - Build all platforms
    echo.
)

echo.
echo =========================================
echo   🃏 Smart Tarot Build Complete!
echo =========================================
echo.
