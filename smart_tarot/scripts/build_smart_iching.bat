@echo off
REM Smart I Ching - Build Script for Windows
REM Builds the Smart I Ching app with I Ching-specific configuration

setlocal EnableDelayedExpansion

echo.
echo =========================================
echo   ☯️ Building Smart I Ching Application
echo =========================================
echo.

REM Set app-specific environment variables
set "APP_TECHNIQUE=iching"
set "APP_NAME=Smart I Ching"
set "PRIMARY_COLOR=0xFFDC2626"
...
if "%1"=="" (
    echo Usage: build_smart_iching.bat [android^|bundle^|ios^|web^|all]
    echo.
    echo Examples:
    echo   build_smart_iching.bat android    - Build Android APK only
    echo   build_smart_iching.bat bundle     - Build Android App Bundle only
    echo   build_smart_iching.bat ios        - Build iOS IPA only
    echo   build_smart_iching.bat web        - Build Web application only
    echo   build_smart_iching.bat all        - Build all platforms
    echo.
)

echo.
echo =========================================
echo   ☯️ Smart I Ching Build Complete!
echo =========================================
echo.
