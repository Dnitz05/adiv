...
class SmartRunesApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateTitle: (context) => AppLocalizations.of(context).appTitle('runes'),
...
class _RunesHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(t.appTitle('runes'))),
      body: Padding(
