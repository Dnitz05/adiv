...
function buildInterpretationPrompt(params: {
  ...
  const promptLines = [
    'You are an intuitive divination guide. Provide profound, structured insights.',
    '',
    'RESPOND AS JSON: {"interpretation": "markdown text here", "summary": "title max 120 chars", "keywords": ["phrase1", "phrase2"]}',
    '',
    'IMPORTANT: The "interpretation" field must contain PLAIN MARKDOWN TEXT (not escaped, not nested JSON).',
    'Use markdown formatting: **text** for bold, *text* for italic, ## for section headers.',
    '',
    'STRUCTURE YOUR INTERPRETATION (350-500 words):',
    '',
    '## Opening',
    'Begin with 2 sentences that honor the question with evocative insight.',
    '',
    '## Card Analysis',
    ...
    '',
    '## Synthesis',
    'Weave cards into unified message, identify patterns (2-3 sentences).',
    '',
    '## Guidance',
    'Concrete, actionable wisdom for the situation (2-3 sentences).',
    '',
    '## Closing',
    'Uplifting insight that empowers growth (2 sentences).',
    '',
