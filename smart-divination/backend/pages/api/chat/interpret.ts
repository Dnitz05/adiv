...
function buildInterpretationPrompt(params: {
  ...
  const promptLines = [
    ...
    '',
    'RESPOND AS JSON: {"interpretation": "string", "summary": "<=120 chars", "keywords": ["max 8 phrases"]}',
    '',
    'STRUCTURE YOUR INTERPRETATION (350-500 words):',
    '',
    '1. OPENING (2 sentences): Honor the question with evocative insight',
    '',
    '2. CARD ANALYSIS (3-4 sentences per card):',
    ...
    '',
    '3. SYNTHESIS (2-3 sentences): Weave cards into unified message, identify patterns',
    '',
    '4. GUIDANCE (2-3 sentences): Concrete, actionable wisdom for the situation',
    '',
    '5. CLOSING (2 sentences): Uplifting insight that empowers growth',
    '',
    'STYLE: Flowing narrative, poetic yet clear, mystical + practical, specific not generic',
    '',
    'AVOID: Keywords in text, deterministic language, predictions, fortune-telling',
    '',
