...
const ELDER_FUTHARK: RuneData[] = [
  ...
  },
  {
    ...
    keywords: {
      ...
      reversed: ['stagnation', 'injustice', 'rigidity', 'irrationality', 'disruption', 'dislocation']
    },
    divinatory: {
  ...
  // Second Aett - Heimdall's Eight
  {
    ...
    meaning: 'Hail',
    keywords: {
      upright: ['crisis', 'disruption', 'awakening', 'natural forces', 'elemental power', 'destruction'],
  ...
  },
  {
    ...
    meaning: 'Yew Tree',
    keywords: {
      upright: ['transformation', 'initiation', 'protection', 'regeneration', 'wisdom', 'endurance'],
  ...
  },
  {
    ...
    keywords: {
      upright: ['mystery', 'hidden knowledge', 'occult', 'feminine mysteries', 'divination', 'chance'],
  ...
  },
  {
    ...
    keywords: {
      upright: ['inheritance', 'legacy', 'spiritual heritage', 'experience', 'value', 'ancestral wisdom'],
...
const RUNE_SPREADS: RuneSpreadDefinition[] = [
  {
    id: 'single',
    name: 'Single Rune',
  ...
  },
  {
    ...
    runeCount: 5,
    positions: [
      { id: 'past_influence', name: 'Past Influence', meaning: 'What shapes your destiny from the past' },
...
export default async function handler(req: NextRequest) {
  ...
  try {
    ...
    const runes: Rune[] = randomResult.values.map((runeIndex, position) => {
      const runeData = ELDER_FUTHARK[runeIndex];
      
      // Determine if rune is reversed (use separate randomness for orientation)
    ...
    // Build response
    const responseData: DrawRunesResponse = {
      data: runes
    };
