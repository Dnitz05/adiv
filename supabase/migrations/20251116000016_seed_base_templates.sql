-- =====================================================
-- SEED: LUNAR GUIDE BASE TEMPLATES
-- =====================================================
-- Purpose: Insert generic base templates for all 8 lunar phases
-- Priority: 0 (generic - used when no element/zodiac-specific template matches)
-- These serve as the foundation layer for modular composition
...
-- Waxing Crescent Template
INSERT INTO lunar_guide_templates (id, phase_id, element, zodiac_sign, headline, tagline, focus_areas, energy_description, recommended_actions, journal_prompts, priority, active)
VALUES (
  'waxing_crescent_generic',
  'waxing_crescent',
  NULL,
  NULL,
...
-- Waxing Gibbous Template
INSERT INTO lunar_guide_templates (id, phase_id, element, zodiac_sign, headline, tagline, focus_areas, energy_description, recommended_actions, journal_prompts, priority, active)
VALUES (
  'waxing_gibbous_generic',
  'waxing_gibbous',
  NULL,
  NULL,
...
-- Waning Gibbous Template
INSERT INTO lunar_guide_templates (id, phase_id, element, zodiac_sign, headline, tagline, focus_areas, energy_description, recommended_actions, journal_prompts, priority, active)
VALUES (
  'waning_gibbous_generic',
  'waning_gibbous',
  NULL,
  NULL,
...
-- Last Quarter Template
INSERT INTO lunar_guide_templates (id, phase_id, element, zodiac_sign, headline, tagline, focus_areas, energy_description, recommended_actions, journal_prompts, priority, active)
VALUES (
  'last_quarter_generic',
  'last_quarter',
  NULL,
  NULL,
...
-- Waning Crescent Template
INSERT INTO lunar_guide_templates (id, phase_id, element, zodiac_sign, headline, tagline, focus_areas, energy_description, recommended_actions, journal_prompts, priority, active)
VALUES (
  'waning_crescent_generic',
  'waning_crescent',
  NULL,
  NULL,
...
-- Verification query
-- SELECT phase_id, element, zodiac_sign, priority FROM lunar_guide_templates ORDER BY phase_id, priority;
